...
class Property(models.Model):
    ...
    indian_currency = models.CharField(max_length=30, default="INR")
    ...
    property_status = models.CharField(
        ...
        default=PropertyStatus.READY_TO_MOVE,
    )
    ...
    available_for = models.CharField(
        max_length=30,
        choices=AvailableFor.choices,
        default=AvailableFor.ALL,
    )
